...
//input   onmousver 事件
    var oInput1=document.querySelector('.input1'),
        oInput2=document.querySelector('.input2');
    //console.log(oInput1);
    //console.log(oInput2);
    oInput1.onmouseover =function(){
        if (oInput2.style.display=='none'){
            oInput2.style.display='block';
        }else{
            oInput2.style.display = 'block'
        }
    };
    oInput1.onmouseout =function(){
        if (oInput2.style.display=='block'){
    ...
    //视频播放
var oSho=document.querySelector('.shishi'),
    oCha=document.querySelector('.shishi .chacha'),
    oBo=document.querySelector('.dr-love .bofang');
    console.log(oBo);
    console.log(oSho);
    oBo.onclick=function(){
        oSho.classList.add('chu')
    };
    console.log(oCha);
    oCha.onclick=function(){
        console.log(1);
        oSho.classList.remove('chu');
        //oSho.classList.add('chu1')
    };
